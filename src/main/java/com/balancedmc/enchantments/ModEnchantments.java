...
public class ModEnchantments {
    ...
    public static Enchantment NETHER_PROTECTION = new MobProtectionEnchantment(entity -> entity.getGroup() == ModEntityGroup.NETHER);
    ...
    public static void registerEnchantments() {
        ...
        Registry.register(Registries.ENCHANTMENT, new Identifier(Main.MOD_ID, "nether_protection"), NETHER_PROTECTION);
